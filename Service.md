# Grid state with a service
If you want to do state management the hard way, there is a service base approach available in the library. (Note this will probably end up deprecated some day)
### Using the library
